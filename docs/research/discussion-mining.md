...
> 挖掘时间：2026-08-14（dsh 0.1.0-rc.6 时代）
...
1. **Windows 中文路径截断家族**（#107 #151 #210 #244 #295 #396 #428 #488 #563 #580 #617 #643 #644 #701 #727 #761 #800 等 17+ 帖，同一根因 readUtf16 低字节 0x00）：白皮书第 3 章提到"端口占用"等坑，但未覆盖此 rc.6 未修复的顶级 bug。→ 建议：第 2 章（工作区选择注意事项）+ FAQ + 第 12 章。
2. **`unknown tool ""` 流式 bug**（#161 #615 #694 #725 #741）：SSE 分块覆盖赋值导致工具名丢失，rc.6 未修复，工具链全部失效。→ 建议：第 6 章踩坑 + FAQ（现象/规避/等修复）。
...
- **时效**：dsh 为 0.1.0-rc.6 时代（2026-08-13 发布后 48h 内），部分 bug 可能已在更新的 rc 修复；引用时请标注版本语境。
