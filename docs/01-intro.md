...
| 版本线 | `0.1.x`（GitHub 当前 tag `v0.1.3-alpha.1`，npm 已发布线 `0.1.2-rc.1`；迭代快，官方明示"将有破坏性变更"） |
...
**Q4：dsh 稳定吗？**
当前仍为预发布阶段（GitHub `v0.1.3-alpha.1`，npm 已发布线 `0.1.2-rc.1`），迭代快、有破坏性变更。生产核心依赖建议等正式版；玩生态现在正是时机。
