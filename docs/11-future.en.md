...
|---|---|---|
| Short | `0.1.0` stable release (drop rc), breaking changes converge | Currently GitHub tag `v0.1.3-alpha.1` (npm published line `0.1.2-rc.1`); official explicitly warns of breaking changes; iteration is fast |
